...
public class TranslationContainer
{
  ...
  public TranslationContainer()
  {
    ...
    this.CompTransMap.put("Texting", "信息");
    ...
    this.CompTransMap.put("BluetoothClient", "蓝牙客户");
  ...
  public String getCorrespondingString(String paramString)
  {
    if (this.CompTransMap.containsKey(paramString)) {
      return (String)this.CompTransMap.get(paramString);
    }
    return "Missing name";
  }
}
...
/* Location:              C:\Users\User\Desktop\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\common\TranslationContainer.class
