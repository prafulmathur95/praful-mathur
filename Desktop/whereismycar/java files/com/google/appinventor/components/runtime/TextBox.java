  ...
  extends TextBoxBase
{
  ...
  public TextBox(ComponentContainer paramComponentContainer)
  {
  ...
  @SimpleProperty
  public void MultiLine(boolean paramBoolean)
  {
    this.multiLine = paramBoolean;
    EditText localEditText = this.view;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      localEditText.setSingleLine(paramBoolean);
      return;
    }
  }
  ...
  public void NumbersOnly(boolean paramBoolean)
  {
    if (paramBoolean) {
    ...
    for (;;)
    {
      this.acceptsNumbersOnly = paramBoolean;
      return;
...
/* Location:              C:\Users\User\Desktop\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\TextBox.class
