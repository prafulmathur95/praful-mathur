...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lgnu/expr/LambdaExp;->unknownContinuation:Lgnu/expr/ApplyExp;
...
.method addMethodFor(Lgnu/bytecode/ClassType;Lgnu/expr/Compilation;Lgnu/bytecode/ObjectType;)V
    ...
    .line 808
    .local v41, outer:Lgnu/expr/LambdaExp;
    ...
    .line 818
    .local v30, methods:[Lgnu/bytecode/Method;
    ...
    invoke-virtual/range {v55 .. v57}, Lgnu/expr/Declaration;->getFlag(J)Z
    ...
    .line 859
    .local v37, nameBuf:Ljava/lang/StringBuffer;
    if-eqz v20, :cond_20
    ...
    invoke-virtual/range {v55 .. v55}, Lgnu/expr/Declaration;->needsExternalAccess()Z
    ...
    :cond_3
    :goto_6
    invoke-virtual/range {v41 .. v41}, Lgnu/expr/LambdaExp;->isModuleBody()Z
    ...
    .line 911
    .local v18, inherited:[Lgnu/bytecode/Method;
    const/16 v17, 0x0
    ...
    .line 916
    .local v42, param:Lgnu/expr/Declaration;
    :goto_a
    if-nez v42, :cond_27
    ...
    .line 973
    .end local v17           #iarg:I
    .end local v18           #inherited:[Lgnu/bytecode/Method;
    .end local v42           #param:Lgnu/expr/Declaration;
    :cond_c
    :goto_b
    const/16 v55, 0x400
    ...
    :cond_d
    sget-object v46, Lgnu/bytecode/Type;->voidType:Lgnu/bytecode/PrimType;

    .line 978
    .local v46, rtype:Lgnu/bytecode/Type;
    :goto_c
    if-eqz p3, :cond_33
    ...
    .line 985
    :cond_e
    invoke-virtual/range {v37 .. v37}, Ljava/lang/StringBuffer;->length()I

    move-result v36

    .line 986
    .local v36, nameBaseLength:I
    const/16 v16, 0x0
    ...
    .line 997
    .local v52, var:Lgnu/expr/Declaration;
    if-eqz v52, :cond_11

    invoke-virtual/range {v52 .. v52}, Lgnu/expr/Declaration;->isThisParameter()Z
    ...
    .line 998
    invoke-virtual/range {v52 .. v52}, Lgnu/expr/Declaration;->nextDecl()Lgnu/expr/Declaration;
    ...
    .restart local v21       #itype:I
    add-int v55, v14, v22

    invoke-virtual/range {v52 .. v52}, Lgnu/expr/Declaration;->getType()Lgnu/bytecode/Type;
    ...
    .line 808
    .end local v5           #atypes:[Lgnu/bytecode/Type;
    .end local v8           #ctxArg:I
    .end local v14           #extraArg:I
    .end local v16           #i:I
    .end local v19           #isInitMethod:C
    .end local v20           #isStatic:Z
    .end local v22           #itype:I
    .end local v24           #key_args:I
    .end local v30           #methods:[Lgnu/bytecode/Method;
    .end local v32           #mflags:I
    .end local v36           #nameBaseLength:I
    .end local v37           #nameBuf:Ljava/lang/StringBuffer;
    .end local v38           #numArgs:I
    .end local v39           #numStubs:I
    .end local v40           #opt_args:I
    .end local v43           #plainArgs:I
    .end local v46           #rtype:Lgnu/bytecode/Type;
    .end local v52           #var:Lgnu/expr/Declaration;
    .end local v53           #varArgs:Z
    .end local v54           #withContext:Z
    :cond_12
    move-object/from16 v0, p0
    ...
    .line 828
    .restart local v19       #isInitMethod:C
    .restart local v30       #methods:[Lgnu/bytecode/Method;
    .restart local v53       #varArgs:Z
    :cond_16
    move-object/from16 v0, p0
    ...
    .restart local v20       #isStatic:Z
    :goto_10
    iget-object v0, v6, Lgnu/expr/ClassExp;->initMethod:Lgnu/expr/LambdaExp;
    ...
    .restart local v20       #isStatic:Z
    :cond_19
    iget-object v0, v6, Lgnu/expr/ClassExp;->clinitMethod:Lgnu/expr/LambdaExp;
    ...
    check-cast v31, Lgnu/expr/ModuleExp;

    .line 853
    .local v31, mexp:Lgnu/expr/ModuleExp;
    invoke-virtual/range {v31 .. v31}, Lgnu/expr/ModuleExp;->getSuperType()Lgnu/bytecode/ClassType;

    move-result-object v55

    if-nez v55, :cond_1e

    invoke-virtual/range {v31 .. v31}, Lgnu/expr/ModuleExp;->getInterfaces()[Lgnu/bytecode/ClassType;
    ...
    .line 856
    .end local v31           #mexp:Lgnu/expr/ModuleExp;
    :cond_1f
    const/16 v20, 0x1
    ...
    .line 859
    .restart local v37       #nameBuf:Ljava/lang/StringBuffer;
    :cond_20
    const/16 v32, 0x0
    ...
    invoke-virtual/range {v55 .. v55}, Lgnu/expr/Declaration;->isPrivate()Z
    ...
    invoke-virtual {v0, v11}, Lgnu/expr/Declaration;->getAccessFlags(S)S
    ...
    .line 881
    invoke-static/range {v35 .. v35}, Lgnu/expr/Compilation;->mangleName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 899
    .restart local v54       #withContext:Z
    :cond_26
    and-int/lit8 v55, v32, 0x2

    add-int/lit8 v32, v55, 0x2

    goto/16 :goto_9

    .line 921
    .restart local v17       #iarg:I
    .restart local v18       #inherited:[Lgnu/bytecode/Method;
    .restart local v42       #param:Lgnu/expr/Declaration;
    :cond_27
    invoke-virtual/range {v42 .. v42}, Lgnu/expr/Declaration;->isThisParameter()Z
    ...
    .line 914
    :cond_28
    invoke-virtual/range {v42 .. v42}, Lgnu/expr/Declaration;->nextDecl()Lgnu/expr/Declaration;
    ...
    .line 931
    .local v28, mangled:Ljava/lang/String;
    new-instance v15, Lgnu/expr/LambdaExp$1;

    move-object/from16 v0, p0

    move-object/from16 v1, v28

    invoke-direct {v15, v0, v1}, Lgnu/expr/LambdaExp$1;-><init>(Lgnu/expr/LambdaExp;Ljava/lang/String;)V

    .line 942
    .local v15, filter:Lgnu/bytecode/Filter;
    const/16 v55, 0x2
    ...
    invoke-virtual {v0, v15, v1}, Lgnu/bytecode/ClassType;->getMethods(Lgnu/bytecode/Filter;I)[Lgnu/bytecode/Method;

    move-result-object v18

    .line 944
    .end local v15           #filter:Lgnu/bytecode/Filter;
    .end local v28           #mangled:Ljava/lang/String;
    :cond_2b
    const/16 v50, 0x0
    ...
    .line 947
    aget-object v29, v18, v16

    .line 948
    .local v29, method:Lgnu/bytecode/Method;
    if-nez v42, :cond_2d

    invoke-virtual/range {v29 .. v29}, Lgnu/bytecode/Method;->getReturnType()Lgnu/bytecode/Type;

    move-result-object v44

    .line 950
    .local v44, ptype:Lgnu/bytecode/Type;
    :goto_14
    if-nez v50, :cond_2e
    ...
    .line 948
    .end local v44           #ptype:Lgnu/bytecode/Type;
    :cond_2d
    invoke-virtual/range {v29 .. v29}, Lgnu/bytecode/Method;->getParameterTypes()[Lgnu/bytecode/Type;

    move-result-object v55

    aget-object v44, v55, v17

    goto :goto_14

    .line 952
    .restart local v44       #ptype:Lgnu/bytecode/Type;
    :cond_2e
    ...
    .line 978
    .restart local v46       #rtype:Lgnu/bytecode/Type;
    :cond_33
    const/4 v14, 0x0
    ...
    .line 1001
    .restart local v5       #atypes:[Lgnu/bytecode/Type;
    .restart local v8       #ctxArg:I
    .restart local v14       #extraArg:I
    .restart local v16       #i:I
    .restart local v22       #itype:I
    .restart local v36       #nameBaseLength:I
    .restart local v38       #numArgs:I
    .restart local v43       #plainArgs:I
    .restart local v52       #var:Lgnu/expr/Declaration;
    :cond_34
    if-eqz v8, :cond_35
    ...
    sget-object v56, Lgnu/expr/Compilation;->typeCallContext:Lgnu/bytecode/ClassType;
    ...
    .line 1006
    .local v25, lastType:Lgnu/bytecode/Type;
    invoke-virtual/range {v25 .. v25}, Lgnu/bytecode/Type;->getName()Ljava/lang/String;

    move-result-object v26

    .line 1007
    .local v26, lastTypeName:Ljava/lang/String;
    invoke-virtual/range {p1 .. p1}, Lgnu/bytecode/ClassType;->getClassfileVersion()I

    move-result v55

    const/high16 v56, 0x31
    ...
    const-string v55, "gnu.lists.LList"
    ...
    .line 1021
    :cond_36
    sget-object v25, Lgnu/expr/Compilation;->objArrayType:Lgnu/bytecode/ArrayType;

    .line 1022
    new-instance v55, Lgnu/bytecode/Variable;

    const-string v56, "argsArray"

    sget-object v57, Lgnu/expr/Compilation;->objArrayType:Lgnu/bytecode/ArrayType;

    invoke-direct/range {v55 .. v57}, Lgnu/bytecode/Variable;-><init>(Ljava/lang/String;Lgnu/bytecode/Type;)V
    ...
    invoke-virtual/range {v55 .. v56}, Lgnu/bytecode/Variable;->setParameter(Z)V
    ...
    aput-object v25, v5, v55

    .line 1029
    .end local v25           #lastType:Lgnu/bytecode/Type;
    .end local v26           #lastTypeName:Ljava/lang/String;
    :cond_38
    if-eqz v54, :cond_39
    ...
    check-cast v55, Lgnu/expr/ModuleExp;

    const/high16 v56, 0x2

    invoke-virtual/range {v55 .. v56}, Lgnu/expr/ModuleExp;->getFlag(I)Z
    ...
    .local v47, t:Lgnu/bytecode/ClassType;
    :goto_1a
    if-eqz v47, :cond_3f
    ...
    invoke-virtual {v0, v1, v5}, Lgnu/bytecode/ClassType;->getDeclaredMethod(Ljava/lang/String;[Lgnu/bytecode/Type;)Lgnu/bytecode/Method;
    ...
    .line 1011
    .end local v7           #classSpecified:Z
    .end local v27           #len:I
    .end local v45           #renameCount:I
    .end local v47           #t:Lgnu/bytecode/ClassType;
    .restart local v25       #lastType:Lgnu/bytecode/Type;
    .restart local v26       #lastTypeName:Ljava/lang/String;
    :cond_3b
    const-string v55, "$V"
    ...
    .line 1059
    .restart local v7       #classSpecified:Z
    .restart local v27       #len:I
    .restart local v45       #renameCount:I
    .restart local v47       #t:Lgnu/bytecode/ClassType;
    :cond_3e
    if-eqz v7, :cond_43
    ...
    invoke-virtual {v0, v1, v5, v2, v3}, Lgnu/bytecode/ClassType;->addMethod(Ljava/lang/String;[Lgnu/bytecode/Type;Lgnu/bytecode/Type;I)Lgnu/bytecode/Method;

    move-result-object v29

    .line 1067
    .restart local v29       #method:Lgnu/bytecode/Method;
    aput-object v29, v30, v16
    ...
    new-array v13, v0, [Lgnu/bytecode/ClassType;

    .line 1073
    .local v13, exceptions:[Lgnu/bytecode/ClassType;
    const/16 v23, 0x0
    ...
    .line 1076
    .local v12, exception:Lgnu/bytecode/ClassType;
    move-object/from16 v0, p0
    ...
    aget-object v48, v55, v23

    .line 1077
    .local v48, throwsExpr:Lgnu/expr/Expression;
    const/16 v33, 0x0
    ...
    .line 1080
    check-cast v49, Lgnu/expr/ReferenceExp;

    .line 1081
    .local v49, throwsRef:Lgnu/expr/ReferenceExp;
    invoke-virtual/range {v49 .. v49}, Lgnu/expr/ReferenceExp;->getBinding()Lgnu/expr/Declaration;
    ...
    .line 1085
    .local v10, declValue:Lgnu/expr/Expression;
    instance-of v0, v10, Lgnu/expr/ClassExp;
    ...
    .end local v10           #declValue:Lgnu/expr/Expression;
    move-object/from16 v0, p2

    invoke-virtual {v10, v0}, Lgnu/expr/ClassExp;->getCompiledClassType(Lgnu/expr/Compilation;)Lgnu/bytecode/ClassType;

    move-result-object v12

    .line 1106
    .end local v9           #decl:Lgnu/expr/Declaration;
    .end local v49           #throwsRef:Lgnu/expr/ReferenceExp;
    :cond_40
    :goto_1c
    if-nez v12, :cond_41
    ...
    .line 1107
    const-string v33, "invalid throws specification"
    ...
    .line 1049
    .end local v12           #exception:Lgnu/bytecode/ClassType;
    .end local v13           #exceptions:[Lgnu/bytecode/ClassType;
    .end local v23           #j:I
    .end local v29           #method:Lgnu/bytecode/Method;
    .end local v33           #msg:Ljava/lang/String;
    .end local v34           #n:I
    .end local v48           #throwsExpr:Lgnu/expr/Expression;
    :cond_43
    invoke-virtual/range {v47 .. v47}, Lgnu/bytecode/ClassType;->getSuperclass()Lgnu/bytecode/ClassType;
    ...
    .restart local v10       #declValue:Lgnu/expr/Expression;
    .restart local v12       #exception:Lgnu/bytecode/ClassType;
    .restart local v13       #exceptions:[Lgnu/bytecode/ClassType;
    .restart local v23       #j:I
    .restart local v29       #method:Lgnu/bytecode/Method;
    .restart local v33       #msg:Ljava/lang/String;
    .restart local v34       #n:I
    .restart local v48       #throwsExpr:Lgnu/expr/Expression;
    .restart local v49       #throwsRef:Lgnu/expr/ReferenceExp;
    :cond_44
    ...
    const-string v56, "unknown class "

    invoke-virtual/range {v55 .. v56}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v55

    invoke-virtual/range {v49 .. v49}, Lgnu/expr/ReferenceExp;->getName()Ljava/lang/String;
    ...
    .line 1097
    check-cast v55, Lgnu/expr/QuoteExp;

    invoke-virtual/range {v55 .. v55}, Lgnu/expr/QuoteExp;->getValue()Ljava/lang/Object;
    ...
    .line 1099
    check-cast v51, Ljava/lang/Class;

    .end local v51           #value:Ljava/lang/Object;
    invoke-static/range {v51 .. v51}, Lgnu/bytecode/Type;->make(Ljava/lang/Class;)Lgnu/bytecode/Type;
    ...
    sget-object v55, Lgnu/bytecode/Type;->javalangThrowableType:Lgnu/bytecode/ClassType;

    move-object/from16 v0, v55

    invoke-virtual {v12, v0}, Lgnu/bytecode/ClassType;->isSubtype(Lgnu/bytecode/Type;)Z
    ...
    const-string v56, " does not extend Throwable"
    ...
    .end local v48           #throwsExpr:Lgnu/expr/Expression;
    :cond_49
    new-instance v4, Lgnu/bytecode/ExceptionsAttr;

    move-object/from16 v0, v29

    invoke-direct {v4, v0}, Lgnu/bytecode/ExceptionsAttr;-><init>(Lgnu/bytecode/Method;)V

    .line 1116
    .local v4, attr:Lgnu/bytecode/ExceptionsAttr;
    invoke-virtual {v4, v13}, Lgnu/bytecode/ExceptionsAttr;->setExceptions([Lgnu/bytecode/ClassType;)V

    .line 986
    .end local v4           #attr:Lgnu/bytecode/ExceptionsAttr;
    .end local v13           #exceptions:[Lgnu/bytecode/ClassType;
    .end local v23           #j:I
    .end local v34           #n:I
    :cond_4a
...
.method allocChildMethods(Lgnu/expr/Compilation;)V
    ...
    .line 1214
    :cond_0
    instance-of v4, v0, Lgnu/expr/ClassExp;
    ...
    .line 1220
    instance-of v4, p0, Lgnu/expr/ModuleExp;

    if-nez v4, :cond_1

    instance-of v4, p0, Lgnu/expr/ClassExp;
    ...
    :goto_1
    iget-object v4, v1, Lgnu/expr/ClassExp;->instanceType:Lgnu/bytecode/ClassType;

    invoke-virtual {v4, v3}, Lgnu/bytecode/ClassType;->setOuterLink(Lgnu/bytecode/ClassType;)Lgnu/bytecode/Field;

    move-result-object v4

    iput-object v4, v1, Lgnu/expr/ClassExp;->staticLinkField:Lgnu/bytecode/Field;

    iput-object v4, v1, Lgnu/expr/ClassExp;->closureEnvField:Lgnu/bytecode/Field;
    ...
    .line 1224
    .restart local v1       #cl:Lgnu/expr/ClassExp;
    :cond_3
...
.method allocFieldFor(Lgnu/expr/Compilation;)Lgnu/bytecode/Field;
    ...
    iget-object v2, v11, Lgnu/expr/Declaration;->field:Lgnu/bytecode/Field;
    ...
    iget v9, p0, Lgnu/expr/LambdaExp;->min_args:I
...
.method public compile(Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    iget-object v2, v4, Lgnu/expr/LambdaExp;->heapFrame:Lgnu/bytecode/Variable;
...
.method compileAsMethod(Lgnu/expr/Compilation;)V
    ...
    .line 1501
    .local v19, save_method:Lgnu/bytecode/Method;
    move-object/from16 v0, p1
    ...
    .line 1502
    .local v18, save_lambda:Lgnu/expr/LambdaExp;
    move-object/from16 v0, p0
    ...
    .line 1507
    .local v14, numStubs:I
    invoke-virtual/range {p0 .. p0}, Lgnu/expr/LambdaExp;->restArgType()Lgnu/bytecode/Type;

    move-result-object v16

    .line 1509
    .local v16, restArgType:Lgnu/bytecode/Type;
    const/16 v17, 0x0

    .line 1510
    .local v17, saveDeclFlags:[J
    if-lez v14, :cond_2
    ...
    .end local v10           #k:I
    .local v11, k:I
    iget-wide v0, v6, Lgnu/expr/Declaration;->flags:J

    move-wide/from16 v24, v0

    aput-wide v24, v17, v10
    ...
    .end local v5           #ctxArg:Z
    .end local v7           #i:I
    .end local v20           #toCall:I
    :cond_3
    const/4 v5, 0x0
    ...
    .restart local v5       #ctxArg:Z
    .restart local v7       #i:I
    .restart local v20       #toCall:I
    :cond_4
    move/from16 v0, v20
    ...
    iget-object v3, v0, Lgnu/expr/Compilation;->callContextVar:Lgnu/bytecode/Variable;
    ...
    .line 1535
    .local v21, var:Lgnu/bytecode/Variable;
    if-nez v8, :cond_6
    ...
    iput-wide v0, v6, Lgnu/expr/Declaration;->flags:J

    .line 1546
    move-object/from16 v0, v21

    iput-object v0, v6, Lgnu/expr/Declaration;->var:Lgnu/bytecode/Variable;
    ...
    .line 1548
    invoke-virtual/range {v21 .. v21}, Lgnu/bytecode/Variable;->nextVar()Lgnu/bytecode/Variable;
    ...
    .end local v6           #decl:Lgnu/expr/Declaration;
    .end local v9           #j:I
    .end local v21           #var:Lgnu/bytecode/Variable;
    .end local v22           #varArgs:Z
    :cond_7
    const/16 v22, 0x0
    ...
    .line 1550
    .restart local v3       #callContextSave:Lgnu/bytecode/Variable;
    .restart local v6       #decl:Lgnu/expr/Declaration;
    .restart local v9       #j:I
    .restart local v21       #var:Lgnu/bytecode/Variable;
    .restart local v22       #varArgs:Z
    :cond_8
    if-eqz v5, :cond_9
    ...
    .line 1554
    .local v15, paramTarget:Lgnu/expr/Target;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v15}, Lgnu/expr/Expression;->compile(Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    .line 1550
    .end local v15           #paramTarget:Lgnu/expr/Target;
    :cond_9
    const/16 v23, 0x0
    ...
    .line 1560
    .local v12, lastTypeName:Ljava/lang/String;
    const-string v23, "gnu.lists.LList"
    ...
    invoke-virtual {v2, v0, v1}, Lgnu/expr/Expression;->compile(Lgnu/expr/Compilation;Lgnu/bytecode/Type;)V

    .line 1568
    .end local v2           #arg:Lgnu/expr/Expression;
    .end local v12           #lastTypeName:Ljava/lang/String;
    :cond_b
    if-eqz v5, :cond_c
    ...
    invoke-virtual {v4, v0}, Lgnu/bytecode/CodeAttr;->emitInvokeStatic(Lgnu/bytecode/Method;)V
    ...
    iput-object v3, v0, Lgnu/expr/Compilation;->callContextVar:Lgnu/bytecode/Variable;
    ...
    .restart local v6       #decl:Lgnu/expr/Declaration;
    .restart local v9       #j:I
    .restart local v12       #lastTypeName:Ljava/lang/String;
    .restart local v20       #toCall:I
    .restart local v21       #var:Lgnu/bytecode/Variable;
    .restart local v22       #varArgs:Z
    :cond_d
    ...
    sget-object v23, Lgnu/mapping/Values;->noArgs:[Ljava/lang/Object;
    ...
    const-string v25, "unimplemented #!rest type "
    ...
    invoke-virtual {v4, v0}, Lgnu/bytecode/CodeAttr;->emitInvokeVirtual(Lgnu/bytecode/Method;)V
...
.method public compileBody(Lgnu/expr/Compilation;)V
    ...
    .end local p0
    :cond_1
    invoke-virtual {v3, p1, v1, p0}, Lgnu/expr/Expression;->compileWithPosition(Lgnu/expr/Compilation;Lgnu/expr/Target;Lgnu/expr/Expression;)V
...
.method enterFunction(Lgnu/expr/Compilation;)V
    ...
    invoke-virtual {v0, v7}, Lgnu/bytecode/Scope;->noteStartFunction(Lgnu/bytecode/CodeAttr;)V
    ...
    iget-object v12, v0, Lgnu/expr/LambdaExp;->closureEnvField:Lgnu/bytecode/Field;
    ...
    .line 1291
    :cond_0
    invoke-virtual {v7, v12}, Lgnu/bytecode/CodeAttr;->emitGetField(Lgnu/bytecode/Field;)V
    ...
    invoke-virtual {v7, v0}, Lgnu/bytecode/CodeAttr;->emitStore(Lgnu/bytecode/Variable;)V
    ...
    .line 1305
    .local v13, frameType:Lgnu/bytecode/ClassType;
    :goto_1
    move-object/from16 v0, p0

    iget-object v9, v0, Lgnu/expr/LambdaExp;->capturedVars:Lgnu/expr/Declaration;
    ...
    .line 1308
    iget-object v0, v9, Lgnu/expr/Declaration;->field:Lgnu/bytecode/Field;
    ...
    .line 1306
    :goto_3
    iget-object v9, v9, Lgnu/expr/Declaration;->nextCapturedVar:Lgnu/expr/Declaration;

    goto :goto_2

    .line 1294
    .end local v9           #decl:Lgnu/expr/Declaration;
    .end local v13           #frameType:Lgnu/bytecode/ClassType;
    :cond_2
    invoke-virtual/range {p0 .. p0}, Lgnu/expr/LambdaExp;->outerLambda()Lgnu/expr/LambdaExp;
    ...
    .line 1310
    .restart local v9       #decl:Lgnu/expr/Declaration;
    .restart local v13       #frameType:Lgnu/bytecode/ClassType;
    :cond_4
    const/16 v27, 0x0
    ...
    invoke-virtual {v9, v13, v0, v1}, Lgnu/expr/Declaration;->makeField(Lgnu/bytecode/ClassType;Lgnu/expr/Compilation;Lgnu/expr/Expression;)V
    ...
    invoke-virtual {v13, v0, v1}, Lgnu/bytecode/ClassType;->addField(Ljava/lang/String;Lgnu/bytecode/Type;)Lgnu/bytecode/Field;
    ...
    invoke-virtual {v13, v0}, Lgnu/bytecode/ClassType;->setEnclosingMember(Lgnu/bytecode/Member;)V

    .line 1322
    invoke-virtual {v7, v13}, Lgnu/bytecode/CodeAttr;->emitNew(Lgnu/bytecode/ClassType;)V

    .line 1323
    invoke-virtual {v7, v13}, Lgnu/bytecode/CodeAttr;->emitDup(Lgnu/bytecode/Type;)V

    .line 1324
    move-object/from16 v0, p0

    invoke-static {v13, v0}, Lgnu/expr/Compilation;->getConstructor(Lgnu/bytecode/ClassType;Lgnu/expr/LambdaExp;)Lgnu/bytecode/Method;
    ...
    invoke-virtual {v7, v0}, Lgnu/bytecode/CodeAttr;->emitPutField(Lgnu/bytecode/Field;)V
    ...
    .line 1337
    .end local v8           #constructor:Lgnu/bytecode/Method;
    .end local v13           #frameType:Lgnu/bytecode/ClassType;
    :cond_8
    move-object/from16 v0, p0

    iget-object v4, v0, Lgnu/expr/LambdaExp;->argsArray:Lgnu/bytecode/Variable;

    .line 1338
    .local v4, argsArray:Lgnu/bytecode/Variable;
    move-object/from16 v0, p0
    ...
    .line 1349
    .end local v15           #key_args:I
    .end local v19           #opt_args:I
    :cond_a
    move-object/from16 v0, p0
    ...
    .line 1357
    .local v11, defaultStart:I
    invoke-virtual/range {p0 .. p0}, Lgnu/expr/LambdaExp;->getMainMethod()Lgnu/bytecode/Method;

    move-result-object v18

    .line 1358
    .local v18, mainMethod:Lgnu/bytecode/Method;
    move-object/from16 v0, p1

    iget-object v6, v0, Lgnu/expr/Compilation;->callContextVar:Lgnu/bytecode/Variable;

    .line 1360
    .local v6, callContextSave:Lgnu/bytecode/Variable;
    invoke-virtual/range {p0 .. p0}, Lgnu/expr/LambdaExp;->firstDecl()Lgnu/expr/Declaration;

    move-result-object v22

    .local v22, param:Lgnu/expr/Declaration;
    move/from16 v17, v16
    ...
    invoke-virtual/range {v22 .. v22}, Lgnu/expr/Declaration;->isSimple()Z
    ...
    .line 1381
    :cond_e
    invoke-virtual/range {v22 .. v22}, Lgnu/expr/Declaration;->getType()Lgnu/bytecode/Type;

    move-result-object v23

    .line 1382
    .local v23, paramType:Lgnu/bytecode/Type;
    if-ltz v24, :cond_15

    sget-object v25, Lgnu/bytecode/Type;->objectType:Lgnu/bytecode/ClassType;

    .line 1388
    .local v25, stackType:Lgnu/bytecode/Type;
    :goto_a
    invoke-virtual/range {v22 .. v22}, Lgnu/expr/Declaration;->isSimple()Z
    ...
    .line 1394
    invoke-virtual/range {v22 .. v22}, Lgnu/expr/Declaration;->getVariable()Lgnu/bytecode/Variable;
    ...
    .line 1482
    sget-object v27, Lgnu/expr/Compilation;->typeLocation:Lgnu/bytecode/ClassType;

    invoke-virtual/range {v26 .. v27}, Lgnu/bytecode/Variable;->setType(Lgnu/bytecode/Type;)V
    ...
    .line 1488
    .end local v23           #paramType:Lgnu/bytecode/Type;
    .end local v25           #stackType:Lgnu/bytecode/Type;
    .end local v26           #var:Lgnu/bytecode/Variable;
    :goto_c
    add-int/lit8 v14, v14, 0x1

    .line 1360
    invoke-virtual/range {v22 .. v22}, Lgnu/expr/Declaration;->nextDecl()Lgnu/expr/Declaration;
    ...
    .restart local v23       #paramType:Lgnu/bytecode/Type;
    :cond_15
    ...
    .line 1396
    .restart local v25       #stackType:Lgnu/bytecode/Type;
    :cond_16
    move-object/from16 v0, p0
    ...
    .line 1398
    invoke-virtual {v7, v4}, Lgnu/bytecode/CodeAttr;->emitLoad(Lgnu/bytecode/Variable;)V

    .line 1399
    invoke-virtual {v7, v14}, Lgnu/bytecode/CodeAttr;->emitPushInt(I)V
    ...
    invoke-virtual {v7, v0}, Lgnu/bytecode/CodeAttr;->emitArrayLoad(Lgnu/bytecode/Type;)V
    ...
    .line 1406
    invoke-virtual {v7}, Lgnu/bytecode/CodeAttr;->emitArrayLength()V

    .line 1407
    invoke-virtual {v7}, Lgnu/bytecode/CodeAttr;->emitIfIntLt()V
    ...
    .line 1410
    invoke-virtual {v7}, Lgnu/bytecode/CodeAttr;->emitArrayLoad()V
    ...
    .line 1422
    sget-object v25, Lgnu/expr/Compilation;->scmListType:Lgnu/bytecode/ClassType;
    ...
    .line 1438
    .local v5, argts:[Lgnu/bytecode/Type;
    const/16 v27, 0x0
    ...
    .line 1447
    .end local v5           #argts:[Lgnu/bytecode/Type;
    :cond_1a
    move-object/from16 v0, p1

    move-object/from16 v1, v23

    invoke-virtual {v10, v0, v1}, Lgnu/expr/Expression;->compile(Lgnu/expr/Compilation;Lgnu/bytecode/Type;)V
    ...
    .line 1455
    .restart local v5       #argts:[Lgnu/bytecode/Type;
    const/16 v27, 0x0
    ...
    invoke-virtual {v7, v0}, Lgnu/bytecode/CodeAttr;->emitDup(I)V
    ...
    .line 1466
    invoke-virtual {v7}, Lgnu/bytecode/CodeAttr;->emitIfEq()V
    ...
    invoke-virtual {v7, v0}, Lgnu/bytecode/CodeAttr;->emitPop(I)V
    ...
    iput-object v6, v0, Lgnu/expr/Compilation;->callContextVar:Lgnu/bytecode/Variable;
...
.method public validateApply(Lgnu/expr/ApplyExp;Lgnu/expr/InlineCalls;Lgnu/bytecode/Type;Lgnu/expr/Declaration;)Lgnu/expr/Expression;
    ...
    invoke-static {v0, v4, v1}, Lgnu/expr/InlineCalls;->inlineCall(Lgnu/expr/LambdaExp;[Lgnu/expr/Expression;Z)Lgnu/expr/Expression;
    ...
    invoke-virtual {v0, v11, v1}, Lgnu/expr/InlineCalls;->visit(Lgnu/expr/Expression;Lgnu/bytecode/Type;)Lgnu/expr/Expression;

    move-result-object p1

    .line 1798
    .end local v11           #inlined:Lgnu/expr/Expression;
    .end local p1
    :cond_0
    :goto_0
    return-object p1
    ...
    invoke-static {v0, v1, v2, v5}, Lgnu/mapping/WrongArguments;->checkArgCount(Ljava/lang/String;III)Ljava/lang/String;
    ...
    invoke-virtual {v7, v0}, Lgnu/expr/Compilation;->inlineOk(Lgnu/expr/Expression;)Z
    ...
    invoke-virtual {v0, v5}, Lgnu/expr/LambdaExp;->getMethod(I)Lgnu/bytecode/Method;
    ...
    iget-object v6, v0, Lgnu/expr/LambdaExp;->outer:Lgnu/expr/ScopeExp;
    ...
    invoke-direct {v15, v14, v0}, Lgnu/expr/PrimProcedure;-><init>(Lgnu/bytecode/Method;Lgnu/expr/LambdaExp;)V
    ...
    invoke-direct {v0, v15, v13}, Lgnu/expr/ApplyExp;-><init>(Lgnu/mapping/Procedure;[Lgnu/expr/Expression;)V
    ...
    .line 1779
    .local v9, curLambda:Lgnu/expr/LambdaExp;
    :goto_2
    if-nez v9, :cond_6
    ...
    const-string v20, "internal error: missing "
    ...
    .line 1781
    :cond_6
    iget-object v0, v9, Lgnu/expr/LambdaExp;->outer:Lgnu/expr/ScopeExp;
    ...
    .line 1786
    .local v10, d:Lgnu/expr/Declaration;
    if-eqz v10, :cond_7

    invoke-virtual {v10}, Lgnu/expr/Declaration;->isThisParameter()Z
    ...
    const-string v20, "calling non-static method "
    ...
    const-string v20, " from static method "
    ...
    .line 1783
    .end local v10           #d:Lgnu/expr/Declaration;
    :cond_8
    ...
    .line 1790
    .restart local v10       #d:Lgnu/expr/Declaration;
    :cond_9
    ...
    new-array v13, v0, [Lgnu/expr/Expression;

    .line 1792
    .restart local v13       #margs:[Lgnu/expr/Expression;
    invoke-virtual/range {p1 .. p1}, Lgnu/expr/ApplyExp;->getArgs()[Lgnu/expr/Expression;
    ...
    new-instance v20, Lgnu/expr/ThisExp;

    move-object/from16 v0, v20

    invoke-direct {v0, v10}, Lgnu/expr/ThisExp;-><init>(Lgnu/expr/Declaration;)V
